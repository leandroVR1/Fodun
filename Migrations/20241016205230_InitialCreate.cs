        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NumeroHabitaciones = table.Column<int>(type: "int", nullable: false),
                    Lavanderia = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    TarifaPorNoche = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    LavanderiaCosto = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    TotalPagar = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    DiasOrdinarios = table.Column<int>(type: "int", nullable: false),
                    DiasEspeciales = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Temporada = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    TipoTemporada = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    NumeroPersonas = table.Column<int>(type: "int", nullable: false),
                    TarifaPorPersona = table.Column<double>(type: "double", nullable: false),
                    TarifaPorNoche = table.Column<double>(type: "double", nullable: false),
                    FechaInicio = table.Column<DateTime>(type: "datetime(6)", nullable: false),
                    FechaFin = table.Column<DateTime>(type: "datetime(6)", nullable: false)
                },
                constraints: table =>
